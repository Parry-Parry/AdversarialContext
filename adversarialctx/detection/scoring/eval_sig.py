...
def main(injectionpath : str, 
    ...
    for subset in subsets:
        ...
        for s in ir_measures.iter_calc([RR(rel=2), nDCG(cutoff=10), nDCG(cutoff=1000), AP(rel=2), R(rel=2, cutoff=1000)], qrels, subscores):
            score = {}
            score['query_id'] = s.query_id
            score['measure'] = s.measure
            score['value'] = s.value
